...
[ProtocolType("Fins")]
[ProtocolType("FinsTcp")]
public class FinsTcpAdapter : ProtocolAdapterBase<OmronFinsNet>
{
    public FinsTcpAdapter(ILogger<FinsTcpAdapter> logger, Global global) : base(logger, global)
    {
    }
    protected override string ProtocolType => "FinsTcp";
