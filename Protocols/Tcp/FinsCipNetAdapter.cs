...
namespace KEDA_EdgeServices.Protocols.Lan;

[ProtocolType("CipNet")]
[ProtocolType("FinsCipNet")]
public class FinsCipNetAdapter : ProtocolAdapterBase<OmronCipNet>
{
    public FinsCipNetAdapter(ILogger<FinsCipNetAdapter> logger, Global global) : base(logger, global)
    {
    }

    protected override string ProtocolType => "FinsCipNet";
