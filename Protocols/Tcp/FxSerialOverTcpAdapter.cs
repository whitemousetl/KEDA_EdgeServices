...
public class FxSerialOverTcpAdapter : ProtocolAdapterBase<MelsecFxSerialOverTcp>
{
    public FxSerialOverTcpAdapter(ILogger<FxSerialOverTcpAdapter> logger, Global global) : base(logger, global)
    {
    }

    protected override string ProtocolType => "FxSerialOverTcp";
