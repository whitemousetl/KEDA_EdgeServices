...
public abstract class ProtocolAdapterBase<TConnection> : IProtocolAdapter where TConnection : IReadWriteNet
{
    protected TConnection _connection = default!;
    protected Global _global;
    protected ILogger _logger;
    protected abstract string ProtocolType { get; }
    public ProtocolAdapterBase(ILogger logger, Global global)
    {
        _logger = logger;
        _global = global;
    }
