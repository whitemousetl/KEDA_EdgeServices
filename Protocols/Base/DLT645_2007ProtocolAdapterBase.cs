...
public abstract class DLT645_2007ProtocolAdapterBase<TConnection> : IProtocolAdapter where TConnection : IReadWriteNet, IDlt645
{
    protected TConnection _connection = default!;
    protected Global _global;
    protected ILogger _logger;
    protected abstract string ProtocolType { get; }
    public DLT645_2007ProtocolAdapterBase(ILogger logger, Global global)
    {
        _logger = logger;
        _global = global;
    }
    ...
    public async Task<List<DeviceDataResult>> ReadOrWriteAsync(Protocol protocol, CancellationToken ct)
    {
        ...
        {
            _connection.Station = device.StationNo;
