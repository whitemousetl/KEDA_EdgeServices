...
public abstract class CJT188ProtocolAdapterBase<TConnection> : IProtocolAdapter where TConnection : IReadWriteNet, ICjt188
{
    protected TConnection _connection = default!;
    protected Global _global;
    protected ILogger _logger;
    protected abstract string ProtocolType { get; }
    public CJT188ProtocolAdapterBase(ILogger logger, Global global)
    {
        _logger = logger;
        _global = global;
    }
